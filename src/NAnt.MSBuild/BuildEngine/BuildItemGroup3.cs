...
namespace NAnt.MSBuild.BuildEngine {
    internal class BuildItemGroup3 : BuildItemGroup {
        ...
        private class BuildItemEnumerator : IEnumerator {
            ...
            public object Current {
                get { return new BuildItem3(_po.Current); }
            }
        ...
        internal BuildItemGroup3(object o) {
            _obj = o;
            _t = _obj.GetType();
        }
        ...
        public override BuildItem AddNewItem(string itemName, string itemInclude) {
            return new BuildItem3(_t.GetMethod("AddNewItem", new Type[] { typeof(string), typeof(string) }).Invoke(_obj, new object[] { itemName, itemInclude }));
        }
    }
}
